...
export const mockAssets: Asset[] = [
  ...
  // Stocks
  { symbol: 'AAPL', name: 'Apple Inc.', type: 'stock', price: 250, change24h: -5.6, changePercent: -2.19, volume: 36890000, high24h: 256, low24h: 249.5, open: 255.5, rsi: 44, macdSignal: 'bearish', trend: 'downtrend', volatility: 1.6, momentum: 40, relativeStrength: 42 },
  { symbol: 'MSFT', name: 'Microsoft Corp.', type: 'stock', price: 395.5, change24h: -6.3, changePercent: -1.57, volume: 26808000, high24h: 404.8, low24h: 394.3, open: 401, rsi: 45, macdSignal: 'bearish', trend: 'downtrend', volatility: 1.8, momentum: 42, relativeStrength: 44 },
  { symbol: 'NVDA', name: 'NVIDIA Corp.', type: 'stock', price: 180, change24h: -2.9, changePercent: -1.58, volume: 160514000, high24h: 186, low24h: 179.9, open: 184.9, rsi: 46, macdSignal: 'bearish', trend: 'downtrend', volatility: 3.8, momentum: 42, relativeStrength: 44 },
  { symbol: 'TSLA', name: 'Tesla Inc.', type: 'stock', price: 391, change24h: -3.8, changePercent: -0.96, volume: 58338000, high24h: 400, low24h: 390, open: 399, rsi: 44, macdSignal: 'bearish', trend: 'downtrend', volatility: 4.8, momentum: 45, relativeStrength: 42 },
  { symbol: 'AMZN', name: 'Amazon.com', type: 'stock', price: 207.7, change24h: -1.86, changePercent: -0.89, volume: 35606000, high24h: 210.6, low24h: 206.2, open: 209.6, rsi: 46, macdSignal: 'neutral', trend: 'sideways', volatility: 2.0, momentum: 46, relativeStrength: 46 },
  { symbol: 'GOOGL', name: 'Alphabet Inc.', type: 'stock', price: 302.3, change24h: -1.27, changePercent: -0.42, volume: 23661000, high24h: 307.7, low24h: 300.4, open: 307, rsi: 48, macdSignal: 'neutral', trend: 'sideways', volatility: 1.5, momentum: 48, relativeStrength: 48 },
  { symbol: 'META', name: 'Meta Platforms', type: 'stock', price: 613.7, change24h: -24.5, changePercent: -3.83, volume: 18904000, high24h: 629, low24h: 609.5, open: 623.9, rsi: 40, macdSignal: 'bearish', trend: 'downtrend', volatility: 3.2, momentum: 32, relativeStrength: 36 },
  { symbol: 'AMD', name: 'AMD Inc.', type: 'stock', price: 105, change24h: -2.5, changePercent: -2.33, volume: 45000000, high24h: 108, low24h: 104, open: 107.5, rsi: 42, macdSignal: 'bearish', trend: 'downtrend', volatility: 4.2, momentum: 38, relativeStrength: 40 },
  ...
  { symbol: 'CRM', name: 'Salesforce Inc.', type: 'stock', price: 278, change24h: -3.2, changePercent: -1.14, volume: 6200000, high24h: 282, low24h: 276, open: 281, rsi: 46, macdSignal: 'neutral', trend: 'sideways', volatility: 2.2, momentum: 44, relativeStrength: 44 },
  { symbol: 'JPM', name: 'JPMorgan Chase', type: 'stock', price: 245, change24h: 1.5, changePercent: 0.62, volume: 9800000, high24h: 247, low24h: 242, open: 243.5, rsi: 52, macdSignal: 'neutral', trend: 'sideways', volatility: 1.5, momentum: 52, relativeStrength: 54 },
  ...
  { symbol: 'MA', name: 'Mastercard Inc.', type: 'stock', price: 555, change24h: 3.5, changePercent: 0.63, volume: 3200000, high24h: 558, low24h: 550, open: 551.5, rsi: 54, macdSignal: 'neutral', trend: 'sideways', volatility: 1.3, momentum: 52, relativeStrength: 55 },
  { symbol: 'WMT', name: 'Walmart Inc.', type: 'stock', price: 92, change24h: 0.4, changePercent: 0.44, volume: 8500000, high24h: 93, low24h: 91.2, open: 91.6, rsi: 50, macdSignal: 'neutral', trend: 'sideways', volatility: 1.0, momentum: 50, relativeStrength: 52 },
  { symbol: 'DIS', name: 'Walt Disney Co.', type: 'stock', price: 98, change24h: -1.2, changePercent: -1.21, volume: 12000000, high24h: 100, low24h: 97, open: 99.2, rsi: 44, macdSignal: 'bearish', trend: 'downtrend', volatility: 2.5, momentum: 44, relativeStrength: 42 },
  { symbol: 'BA', name: 'Boeing Co.', type: 'stock', price: 178, change24h: 2.5, changePercent: 1.43, volume: 7800000, high24h: 180, low24h: 175, open: 175.5, rsi: 52, macdSignal: 'neutral', trend: 'sideways', volatility: 3.0, momentum: 54, relativeStrength: 54 },
  { symbol: 'INTC', name: 'Intel Corp.', type: 'stock', price: 23.5, change24h: -0.5, changePercent: -2.08, volume: 35000000, high24h: 24.2, low24h: 23.3, open: 24, rsi: 38, macdSignal: 'bearish', trend: 'downtrend', volatility: 4.5, momentum: 38, relativeStrength: 36 },
  { symbol: 'KO', name: 'Coca-Cola Co.', type: 'stock', price: 62, change24h: 0.3, changePercent: 0.49, volume: 11000000, high24h: 62.5, low24h: 61.5, open: 61.7, rsi: 52, macdSignal: 'neutral', trend: 'sideways', volatility: 0.8, momentum: 50, relativeStrength: 52 },
  ...
  { symbol: 'PYPL', name: 'PayPal Holdings', type: 'stock', price: 72, change24h: -1.1, changePercent: -1.50, volume: 9500000, high24h: 73.5, low24h: 71.5, open: 73.1, rsi: 42, macdSignal: 'bearish', trend: 'downtrend', volatility: 3.0, momentum: 42, relativeStrength: 40 },
  { symbol: 'UBER', name: 'Uber Technologies', type: 'stock', price: 78, change24h: 1.2, changePercent: 1.56, volume: 14000000, high24h: 79, low24h: 76.5, open: 76.8, rsi: 54, macdSignal: 'bullish', trend: 'sideways', volatility: 3.5, momentum: 54, relativeStrength: 56 },
  { symbol: 'COIN', name: 'Coinbase Global', type: 'stock', price: 215, change24h: 5.5, changePercent: 2.62, volume: 8200000, high24h: 218, low24h: 208, open: 209.5, rsi: 56, macdSignal: 'bullish', trend: 'uptrend', volatility: 5.5, momentum: 58, relativeStrength: 60 },
  { symbol: 'PLTR', name: 'Palantir Tech.', type: 'stock', price: 85, change24h: 2.8, changePercent: 3.41, volume: 52000000, high24h: 87, low24h: 82, open: 82.2, rsi: 62, macdSignal: 'bullish', trend: 'uptrend', volatility: 5.8, momentum: 62, relativeStrength: 66 },
  { symbol: 'SNOW', name: 'Snowflake Inc.', type: 'stock', price: 165, change24h: -2.5, changePercent: -1.49, volume: 4500000, high24h: 168, low24h: 163, open: 167.5, rsi: 44, macdSignal: 'bearish', trend: 'downtrend', volatility: 3.8, momentum: 42, relativeStrength: 42 },
  // ETFs
  ...
  { symbol: 'EUR/USD', name: 'Euro/Dollar', type: 'commodity', price: 1.0885, change24h: 0.002, changePercent: 0.18, volume: 0, high24h: 1.0910, low24h: 1.0860, open: 1.0865, rsi: 52, macdSignal: 'neutral', trend: 'sideways', volatility: 0.5, momentum: 50, relativeStrength: 52 },
  { symbol: 'GBP/USD', name: 'Pound/Dollar', type: 'commodity', price: 1.2935, change24h: 0.003, changePercent: 0.23, volume: 0, high24h: 1.2960, low24h: 1.2900, open: 1.2905, rsi: 54, macdSignal: 'neutral', trend: 'sideways', volatility: 0.4, momentum: 50, relativeStrength: 54 },
  { symbol: 'USD/JPY', name: 'Dollar/Yen', type: 'commodity', price: 148.5, change24h: -0.3, changePercent: -0.20, volume: 0, high24h: 149.2, low24h: 148.1, open: 148.8, rsi: 48, macdSignal: 'neutral', trend: 'sideways', volatility: 0.6, momentum: 48, relativeStrength: 48 },
  { symbol: 'AUD/USD', name: 'Aussie/Dollar', type: 'commodity', price: 0.6325, change24h: 0.001, changePercent: 0.16, volume: 0, high24h: 0.6345, low24h: 0.6305, open: 0.6315, rsi: 48, macdSignal: 'neutral', trend: 'sideways', volatility: 0.5, momentum: 50, relativeStrength: 48 },
  { symbol: 'USD/CAD', name: 'Dollar/CAD', type: 'commodity', price: 1.3685, change24h: -0.001, changePercent: -0.07, volume: 0, high24h: 1.3710, low24h: 1.3660, open: 1.3690, rsi: 50, macdSignal: 'neutral', trend: 'sideways', volatility: 0.4, momentum: 50, relativeStrength: 50 },
  { symbol: 'USD/CHF', name: 'Dollar/Swiss', type: 'commodity', price: 0.8845, change24h: -0.002, changePercent: -0.23, volume: 0, high24h: 0.8870, low24h: 0.8825, open: 0.8867, rsi: 46, macdSignal: 'neutral', trend: 'sideways', volatility: 0.5, momentum: 48, relativeStrength: 46 },
  { symbol: 'NZD/USD', name: 'Kiwi/Dollar', type: 'commodity', price: 0.5742, change24h: 0.001, changePercent: 0.17, volume: 0, high24h: 0.5758, low24h: 0.5725, open: 0.5735, rsi: 48, macdSignal: 'neutral', trend: 'sideways', volatility: 0.5, momentum: 50, relativeStrength: 48 },
  { symbol: 'EUR/GBP', name: 'Euro/Pound', type: 'commodity', price: 0.8415, change24h: -0.001, changePercent: -0.12, volume: 0, high24h: 0.8430, low24h: 0.8400, open: 0.8425, rsi: 48, macdSignal: 'neutral', trend: 'sideways', volatility: 0.3, momentum: 50, relativeStrength: 48 },
  { symbol: 'EUR/JPY', name: 'Euro/Yen', type: 'commodity', price: 161.7, change24h: -0.2, changePercent: -0.12, volume: 0, high24h: 162.3, low24h: 161.2, open: 161.9, rsi: 48, macdSignal: 'neutral', trend: 'sideways', volatility: 0.5, momentum: 50, relativeStrength: 48 },
  { symbol: 'GBP/JPY', name: 'Pound/Yen', type: 'commodity', price: 192.1, change24h: 0.3, changePercent: 0.16, volume: 0, high24h: 192.8, low24h: 191.5, open: 191.8, rsi: 50, macdSignal: 'neutral', trend: 'sideways', volatility: 0.6, momentum: 50, relativeStrength: 52 },
];
