...
export const mockPortfolio: PortfolioPosition[] = [
  ...
  { symbol: 'NVDA', name: 'NVIDIA', type: 'stock', quantity: 50, avgEntry: 108, currentPrice: 117.60, pnl: 480, pnlPercent: 8.89, allocation: 22.1, stopLoss: 100, takeProfit: 135, strategy: 'Momentum' },
