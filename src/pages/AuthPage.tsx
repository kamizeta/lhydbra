      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="terminal-border rounded-lg p-6 space-y-4">
          ...
          <button
            ...
            className="w-full py-2.5 bg-foreground text-background rounded-md font-semibold text-sm hover:opacity-90 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
          >
