...
const SOURCE_COLORS: Record<string, string> = {
  ...
  "exchangerate-api": "bg-cyan-500/20 text-cyan-400 border-cyan-500/30",
  alpaca: "bg-lime-500/20 text-lime-400 border-lime-500/30",
...
const SOURCE_LIMITS: Record<string, string> = {
  ...
  alpaca: "200 req/min · reset 1 min · batch N sym/req · 15min delay free",
