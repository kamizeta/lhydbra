...
import { Bot, Brain, Target, Shield, FileText, PieChart, GraduationCap, Activity, Play, Loader2, Zap, History, ChevronDown, ChevronUp, Trash2 } from "lucide-react";
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex rounded-md border border-border overflow-hidden">
            <button onClick={() => setViewMode('panel')} className={cn("px-3 py-1.5 text-xs font-medium transition-colors", viewMode === 'panel' ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:bg-accent")}>
              <Bot className="h-3.5 w-3.5 inline mr-1" />Panel
            </button>
            <button onClick={() => setViewMode('history')} className={cn("px-3 py-1.5 text-xs font-medium transition-colors", viewMode === 'history' ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:bg-accent")}>
              <History className="h-3.5 w-3.5 inline mr-1" />Historial
            </button>
          </div>
